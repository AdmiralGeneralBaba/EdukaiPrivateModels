...
async def stage_4_activity_module_1_brainstorming_slide_content_creation(lesson_facts) : 
        gpt_agent = OpenAI()
        temp = 1
...
async def stage_4_activity_module_1_brainstorming_combined_process(lesson_facts) : 
    slide = await stage_4_activity_module_1_brainstorming_slide_content_creation(lesson_facts)
