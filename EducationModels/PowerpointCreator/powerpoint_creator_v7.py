...
"""      
    ...
    def stage_2_1_powerpoint_plan_activity_question_addition(self, powerpoint_plan, lesson_facts) : 
        gptAgent = OpenAI()
        stage_2_1_temp = 0.6
...
"""
    ...
    def stage_2_2_question_activity_submodule_choice_insertion(self, powerpoint_plan, lesson_facts) : 
        gpt_agent = OpenAI()
        stage_2_1_temp = 0.91
...
################ MODULE EXTRACTION CODE ###################:
    ...
    async def stage_6_create_powerpoint(self, lessonFacts) : 
...
# facts_test = "TASK : [{What is the initial strategic consideration in Hearts of Iron IV?}, {How many research slots do most nations start with in the game?}, {What should be the primary focus at the game's commencement in terms of industrial production?}, {Which technologies are crucial for boosting factory build speed and productivity?}, {What should be the priority in early civilian production?}]."
...
def replace_fact_numbers_with_texts(input_string, test_facts):
    # Parse the facts string to create a mapping of fact number to fact text
    facts = re.findall(r'(\d+)\. \{([^}]+)\}', test_facts)
    ...
    return re.sub(r'\{([\d, ]+)\}, ([^\n]+)', replace_fact, input_string)

# Example usage
input_string = """ {1, 2, 3}, Overview of game strategy complexity and time considerations in Hearts of Iron IV

{4, 9},  Strategic planning and political power usage in early game
{5, 11}, Research slot availability and strategies for advanced technology research
{6, 7, 10}, Prioritization of industrial and military research in the early game
{8, 12}, Importance of research technologies and considerations for major powers"""

test_facts = "1. {Challenging the Royal Navy with battleships or cruisers takes a lot of time in Hearts of Iron IV.} 2. {Submarines are only moderately effective against large surface fleets in Hearts of Iron IV.} 3. {In Hearts of Iron IV, decisions connect to each other and many choices won't bear fruit for months or years down the line.} 4. {Players need to spend the early game thinking about their larger strategic vision.} 5. {In Hearts of Iron IV, most nations start with three research slots, with the possibility of four if they are lucky.} 6. {Industrial production should be the number one focus in the early game, with research focused on technologies that increase factory construction speed and productivity.} 7. {The Industry tab in the research tree should be prioritized, specifically the Construction and Production trees.} 8. {Researching technologies that speed up research, such as computing and radar, is important for unlocking better weapons and tactics.} 9. {Choosing political/military advisors that complement research or production is a good use of early Political Power.} 10. {Support companies and military doctrines should not be neglected in research.} 11. {Researching advanced technologies early is possible if there is a research bonus attached to a national focus or military/political advisor.} 12. {Atomic or rocket weapons research requires a lot of time and infrastructure, and is best suited for major powers like the USA, USSR, and Germany.}"

result = replace_fact_numbers_with_texts(input_string, test_facts)
print(result)


# test_facts = "1. {Challenging the Royal Navy with battleships or cruisers takes a lot of time in Hearts of Iron IV.} 2. {Submarines are only moderately effective against large surface fleets in Hearts of Iron IV.} 3. {In Hearts of Iron IV, decisions connect to each other and many choices won't bear fruit for months or years down the line.} 4. {Players need to spend the early game thinking about their larger strategic vision.} 5. {In Hearts of Iron IV, most nations start with three research slots, with the possibility of four if they are lucky.} 6. {Industrial production should be the number one focus in the early game, with research focused on technologies that increase factory construction speed and productivity.} 7. {The Industry tab in the research tree should be prioritized, specifically the Construction and Production trees.} 8. {Researching technologies that speed up research, such as computing and radar, is important for unlocking better weapons and tactics.} 9. {Choosing political/military advisors that complement research or production is a good use of early Political Power.} 10. {Support companies and military doctrines should not be neglected in research.} 11. {Researching advanced technologies early is possible if there is a research bonus attached to a national focus or military/political advisor.} 12. {Atomic or rocket weapons research requires a lot of time and infrastructure, and is best suited for major powers like the USA, USSR, and Germany.}"

# test_groupings = """{1, 2, 3}, Overview of game strategy complexity and time considerations in Hearts of Iron IV
# {4, 9}, Strategic planning and political power usage in early game
# {5, 11}, Research slot availability and strategies for advanced technology research
# {6, 7, 10}, Prioritization of industrial and military research in the early game
# {8, 12}, Importance of research technologies and considerations for major powers"""

# test = PowerpointCreatorV6()
